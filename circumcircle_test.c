...
printf("Caculating circumcircle..%d..\n", iwin);
...
printf("b12: %10.6f %10.6f %10.6f\n", b12[0],  b12[1],  b12[2]);
printf("b23: %10.6f %10.6f %10.6f\n", b23[0],  b23[1],  b23[2]);
printf("b31: %10.6f %10.6f %10.6f\n", b31[0],  b31[1],  b31[2]);
...
printf("m12: %10.6f %10.6f %10.6f\n", m12[0],  m12[1],  m12[2]);
printf("m23: %10.6f %10.6f %10.6f\n", m23[0],  m23[1],  m23[2]);
...
*p_centre = p_atom1->x + m12[0];
 p_centre++;
*p_centre = p_atom1->y + m12[1];
 p_centre++;
*p_centre = p_atom1->z + m12[2];
